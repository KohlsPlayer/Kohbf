...
local Window = Fluent:CreateWindow({
    Title = "KOHLS HUB",
    SubTitle = "©Melhor Script da atualidade fih !",
    TabWidth = 160,
...
local Tabs = {
    ...
    Setting = Window:AddTab({ Title = "Configuração", Icon = "settings" }),
    ...
    Fruit = Window:AddTab({ Title = "Frutas", Icon = "cherry" }),
    Raid = Window:AddTab({ Title = "Raid/Dungeon", Icon = "swords" }),
    Race = Window:AddTab({ Title = "Raça V4", Icon = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Loja", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Mais", Icon = "list-plus" }),
}
...
--Create Tabs
    ...
    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Auto Mobs Proximos", Default = false })
    ...
    spawn(function()
      ...
      Tabs.Main:AddButton({
        Title = "Resgatar Todos Codigos",
        Description = "Resgata todos codigos existentes!",
        Callback = function()
            UseCode()
        end
    })
    ...
    Tabs.Main:AddButton({
        Title = "Fps Boost",
        Description = "Melhora seu desempenho",
        Callback = function()
            FPSBooster()
        end
    })
...
--Mastery
    Tabs.Main:AddParagraph({
        Title = "Maestria Farm",
        Content = "Auto farm maestria"
    })

    local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
        Title = "Modo de Farm",
        Values = {"Nivel","Mobs Proximos",},
        Multi = false,
        Default = 1,
    })

    DropdownMastery:SetValue("Nivel")

    DropdownMastery:OnChanged(function(Value)
        TypeMastery = Value
    end)

    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Maestria Fruta", Default = false })
    ToggleMasteryFruit:OnChanged(function(Value)
        AutoFarmMasDevilFruit = Value
    end)
    Options.ToggleMasteryFruit:SetValue(false)

    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Maestria Arma", Default = false })
    ...
    local SliderHealt = Tabs.Main:AddSlider("SliderHealt", {
        Title = "Vida %",
        Description = "Porcentagem da vida",
        Default = 40,
        Min = 0,
        Max = 100,
        Rounding = 1,
	...
	spawn(function()
        ...
        if AutoFarmMasGun and TypeMastery == 'Nivel' then
        pcall(function()
      ...
      --v.Humanoid:ChangeState(14)
        ...
        elseif AutoFarmMasGun and TypeMastery == 'Mobs Proximos' then
        pcall(function()
          for i,v in pairs (game.Workspace.Enemies:GetChildren()) do
      ...
      Click()
          ...
          until not AutoFarmMasGun or not MasteryType == 'Mobs Proximos' or not v.Parent or v.Humanoid.Health <= 0 or not TypeMastery == 'Mobs Proximos'
          UseSkillGun = false
          end
...
spawn(function()
while task.wait(.1) do
if AutoFarmMasDevilFruit and TypeMastery == 'Nivel' then
pcall(function()
  CheckLevel(SelectMonster)
  if not string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
...
elseif AutoFarmMasDevilFruit and TypeMastery == 'Mobs Proximos' then
pcall(function()
  for i,v in pairs (game.Workspace.Enemies:GetChildren()) do
  if v.Name and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
  if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 2000 then
...
Tabs.Main:AddParagraph({
    Title = "Mais Farms",
    Content = "Ossos & Cake Prince & "
})

local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Auto Farm Ossos", Default = false })
...
spawn(function()
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Auto Farm Ectoplasma", Default = false })
...
if Third_Sea then
      ...
      Tabs.Main:AddParagraph({
        Title = "Mar Estrondoso",
        Content = "Auto mar estrondoso"
    })


    local ToggleBoat = Tabs.Main:AddToggle("ToggleBoat", {Title = "Barco Automatico", Default = false })
   ...
   local ToggleTW = Tabs.Main:AddToggle("ToggleTW", {Title = "Auto Navegar", Default = false })
   ...
   ToggleTW:OnChanged(function(Value)
    ...
    local ToggleTerrorshark = Tabs.Main:AddToggle("ToggleTerrorshark", {Title = "Auto Terrorshark", Default = false })
    ...
    spawn(function()
     ...
     Tabs.Main:AddParagraph({
        Title = "Elite Hunter",
        Content = "Achar e matar caçadores de elite"
    })
...
local ToggleAutoW = Tabs.Main:AddToggle("ToggleAutoW", {Title = "Auto Navegar", Default = false })
ToggleAutoW:OnChanged(function(Value)
 ...
 Tabs.Main:AddParagraph({
    Title = "Ilha da Miragem",
    Content = "Auto sumonar ilha miragem"
})



local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Auto Miragem", Default = false })
...
for _,v in next, workspace.Boats.MarineBrigade:GetDescendants() do
 ...
 local AutoW = Tabs.Main:AddToggle("AutoW", {Title = "Auto Navegar", Default = false })
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
    ...
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Auto Foice Sagrada [Full]", Default = false })
	...
	spawn(function()
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Auto Farm Fabrica", Default = false })
...
--Setting
    Tabs.Setting:AddParagraph({
        Title = "Settings",
        Content = "Settings de farm"
    })

    local ToggleFastAttack = Tabs.Setting:AddToggle("ToggleFastAttack", {Title = "Ataque Rapido", Default = true })
...
CamShake:Stop()
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Juntar Mobs", Default = true })
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Tp Seguro", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Remover Texto Dano", Default = true })
...
Tabs.Setting:AddParagraph({
    Title = "Setting de Skill",
    Content = "Skill para farm de maestria"
})
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Soco", Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Defesa", Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Espada", Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Arma", Default = false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Fruta", Default = false })
...
Tabs.Player:AddButton({
    Title = "Recarregar",
    Description = "Recarregar lista de players",
    Callback = function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Ir ao Player", Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Espectar Player", Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Comprar Frutas", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Girar Fruta", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Coletar Frutas", Default = false })
...
local ToggleEspPlayer = Tabs.Fruit:AddToggle("ToggleEspPlayer", {Title = "Localizar Jogadores", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Localizar Frutas", Default = false })
...
local ToggleEspIsland = Tabs.Fruit:AddToggle("ToggleEspIsland", {Title = "Localizar Ilhas", Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "Localizar Flores", Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Iniciar Raid", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Despertar", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Pagar Frutas Baratas", Default = false })
...
local ToggleHumanandghoul = Tabs.Race:AddToggle("ToggleHumanandghoul", {Title = "Auto [ Humano / Ghoul ] Trial", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Random Osso", Default = false })
...
Tabs.Misc:AddButton({
	Title = "Buscar Server Poucos Jogadores",
	Description = "",
	Callback = function()
